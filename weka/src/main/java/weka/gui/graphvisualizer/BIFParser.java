...
public class BIFParser implements GraphConstants {
     ...
     * @throws Exception             if both the inString and inStream are null, i.e. no
     *                               input has been provided
     * @throws BIFFormatException    if there is format of the input is not
     *                               correct. The format should conform to XMLBIF version 0.3
     * @throws NumberFormatException if there is an invalid char in the
